...
// Map hotel names from UI to index.json keys
const HOTEL_NAME_MAP: Record<string, string> = {
  "JARDINS DE LA KOUTOUBIA": "JARDINS DE LA KOUTOUBIA",
  "SOFITEL MARRAKECH PALAIS IMPERIAL": "SOFITEL MARRAKECH PALAIS IMPERIAL",
  "BARCELO PALMERAIE": "BARCELO PALMERAIE",
  "KENZI ROSE GARDEN": "KENZI ROSE GARDEN",
  "HIVERNAGE": "HIVERNAGE",
  "DAR SABRA": "DAR SABRA",
  "RIAD AL JAZIRA": "RIAD AL JAZIRA",
  "HOTEL IBEROSTAR": "HOTEL IBEROSTAR",
  "HOTEL RADISSON": "HOTEL RADISSON",
  "PURE HOUSE": "PURE HOUSE",
  "HOTEL DU GOLF, PICKALBATROS": "HOTEL DU GOLF, PICKALBATROS",
  "VILLA ALBAICIN": "VILLA ALBAICIN",
  "VILLA ANTHEA": "VILLA ANTHEA",
  "MAMOUNIA": "MAMOUNIA",
  "FELLAH": "FELLAH",
  "ES SAADI": "ES SAADI",
  "MOVENPICK": "MOVENPICK",
  "DOMAINE DE LA ROSERAIE": "DOMAINE DE LA ROSERAIE",
  "PALAIS RONSARD HOTEL": "PALAIS RONSARD HOTEL",
  "TIGMIZA": "TIGMIZA",
  "KASBAH D'IF": "KASBAH D'IF",
  "PARK HYATT": "PARK HYATT",
  "BIVOUAC SOUS LES ETOILES": "BIVOUAC SOUS LES ETOILES",
...
const CATEGORY_OPTIONS = {
  ...
  "Déjeuner": ["DEJEUNER A L'HOTEL", "DAR CHERIFA", "DEJEUNER AU DADA", "KASBAH BELDI DEJEUNER ET DETENTE", "KSAR EL HAMRA", "LA PAUSE", "LE FLOUKA", "LODGE DU DESERT", "TERRASSE DES EPICES"].sort(),
  "Activité": ["ACTIVITES A LA CARTE", "AMANAR", "APRES MIDI DE REUNION", "APRES MIDI LIBRE", "ATELIER CALIGRAPHIE", "ATELIER POTERIE", "CHALLENGE CAROSSA", "COURS DE CUISINE CHEF TARIK", "COURS DE CUISINE MEDINA", "DECOUVERTE DES SOUKS", "DETENTE BELDI COUNTRY CLUB", "EXCURSION EN 4X4", "JOURNEE DE REUNION", "KARTING", "MATINEE DE REUNION", "MATINEE LIBRE", "MEDERSA BEN YOUSSEF", "MONTGOLFIERE", "MUSEE YSL ET JARDINS MAJORELLES", "OLYMPIADES BERBERES", "PALAIS DE LA BAHIA", "QUAD", "QUAD ET BUGGY A AGAFAY", "QUAD ET BUGGY AUTOUR DU LAC", "RALLYE KASBAH EXPRESS", "SPA", "TRANSFERT EN CALECHE", "TREK DANS L'ATLAS AVEC DEJEUNER A LA KASBAH DU TOUBKAL", "TREK DANS L'ATLAS AVEC DEJEUNER CHEZ L'HABITANT", "YOGA"].sort(),
  "Soirée": ["AFTER AU BABOUCHKA", "BO ZIN", "CASINO", "DAR MOHA", "DAR SOUKKAR", "DAR ZELLIJ", "DINER A L'HOTEL", "EPICURIEN", "JARDIN LOTUS", "KASBAH BELDI DEJEUNER ET DETENTE", "LA MAISON ARABE", "LE KABANA", "LE NOUBA", "LE VERGER PALAIS RONSARD", "NARWANA", "NOMAD ROOFTOP", "PALAIS GHARNATA", "PALAIS JAD MAHAL", "SOIREE BELDI COUNTRY CLUB", "SOIREE BLANCHE DANS LE DESERT D'AGAFAY", "SOIREE CAMPEMENT DAR CAID PALMERAIE", "SOIREE CAMPEMENT PALMERAIE", "SOIREE DANS LE DESERT", "TERRES AMANAR"].sort()
}
