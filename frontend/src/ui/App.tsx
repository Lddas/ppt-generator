...
const CATEGORY_OPTIONS = {
  "Divers": ["ARRIVEE", "DEPART", "DEPART AEROPORT EN 4X4", "APRES MIDI LIBRE", "MATINEE LIBRE", "ACTIVITES A LA CARTE", "CHOIX D'ACTIVITES"],
  "Petit Déjeuner": ["PETIT DEJEUNER A L'HOTEL", "PETIT DEJEUNER BELDI COUNTRY CLUB", "PETIT DEJEUNER BERBERE"],
  "Déjeuner": ["DEJEUNER A L'HOTEL", "LODGE DU DESERT", "KASBAH BELDI DEJEUNER ET DETENTE", "LE FLOUKA", "KSAR EL HAMRA", "DAR CHERIFA", "DEJEUNER AU DADA", "LA PAUSE", "TERRASSE DES EPICES"],
  "Activité": ["MONTGOLFIERE", "YOGA", "KARTING", "TRANSFERT EN CALECHE", "RALLYE KASBAH EXPRESS", "EXCURSION EN 4X4", "OLYMPIADES BERBERES", "QUAD ET BUGGY A AGAFAY", "QUAD ET BUGGY AUTOUR DU LAC", "QUAD", "COURS DE CUISINE MEDINA", "COURS DE CUISINE CHEF TARIK", "DECOUVERTE DES SOUKS", "MUSEE YSL ET JARDINS MAJORELLES", "PALAIS DE LA BAHIA", "MEDERSA BEN YOUSSEF", "AMANAR", "TREK DANS L'ATLAS AVEC DEJEUNER CHEZ L'HABITANT", "TREK DANS L'ATLAS AVEC DEJEUNER A LA KASBAH DU TOUBKAL", "CHALLENGE CAROSSA", "JOURNEE DE REUNION", "MATINEE DE REUNION", "APRES MIDI DE REUNION", "DETENTE BELDI COUNTRY CLUB", "SPA", "ATELIER POTERIE", "ATELIER CALIGRAPHIE"],
  "Soirée": ["DINER A L'HOTEL", "SOIREE DANS LE DESERT", "PALAIS JAD MAHAL", "PALAIS GHARNATA", "DAR SOUKKAR", "DAR ZELLIJ", "AFTER AU BABOUCHKA", "NOMAD ROOFTOP", "LA MAISON ARABE", "BO ZIN", "JARDIN LOTUS", "NARWANA", "EPICURIEN", "CASINO", "DAR MOHA", "TERRES AMANAR", "SOIREE BELDI COUNTRY CLUB", "LE VERGER PALAIS RONSARD", "SOIREE BLANCHE DANS LE DESERT D'AGAFAY", "LE NOUBA", "SOIREE CAMPEMENT DAR CAID PALMERAIE", "LE KABANA", "SOIREE CAMPEMENT PALMERAIE"]
}
